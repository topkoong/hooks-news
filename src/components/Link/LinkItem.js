  ...
  function handleVote() {
    if(!user) {
      ...
      voteRef.get().then(doc => {
        // it's possible that we couldn't find the document
        if(doc.exists) {
  ...
  return (
    <div className='flex items-start mt2'>
      ...
      <div className="ml2">
        ...
        <div className="f6 leading-loose gray">
          {link.voteCount} vote by {link.postedBy.name} {distanceInWordsToNow(link.created)}
          {' | '}
